...
const unsigned CanLedPort = 2;
const unsigned CanLedPin  = 6;

const unsigned StatusLedPort = 2;
const unsigned StatusLedPin  = 0;
...
{
    { IOCON_PIO2_6, IOCON_FUNC0 | IOCON_MODE_INACT }, // CAN LED
    { IOCON_PIO2_0, IOCON_FUNC0 | IOCON_MODE_INACT }  // Status LED
};
...
void initGpio()
{
    ...
    LPC_GPIO[CanLedPort].DIR    |= 1 << CanLedPin;
...
{
    LPC_GPIO[CanLedPort].DATA[1 << CanLedPin] = static_cast<unsigned long>(!state) << CanLedPin;
}
