 ...
 *
 * Board initialization for Olimex LPC11C24 and EPM hardware.
 */
...
constexpr unsigned MagnetCtrlPinRightHigh = 1U << 8;   // PIO2_8

constexpr unsigned MagnetCtrlPinRightLow  = 1U << 1;   // PIO2_1
constexpr unsigned MagnetCtrlPinLeftHigh  = 1U << 7;   // PIO2_7
...
void readUniqueID(UniqueID& out_uid)
{
    ...
    std::memcpy(out_uid.data(), &aligned_array[1], 16);
}
...
void setMagnetPos()
{
    ...
    board::delayUSec(50);
    gpio::set(MagnetCtrlPortNum, MagnetCtrlPinRightHigh, MagnetCtrlPinRightHigh);
    board::delayUSec(20);
    gpio::set(MagnetCtrlPortNum, MagnetCtrlPinRightHigh, 0);
...
void setMagnetNeg()
{
    ...
    board::delayUSec(50);
    gpio::set(MagnetCtrlPortNum, MagnetCtrlPinLeftHigh, MagnetCtrlPinLeftHigh);
    board::delayUSec(20);
    gpio::set(MagnetCtrlPortNum, MagnetCtrlPinRightLow, 0);
    gpio::set(MagnetCtrlPortNum, MagnetCtrlPinLeftHigh, 0);
}
...
unsigned getOutVoltageInVolts()
{
    ...
    (void)Chip_ADC_ReadValue(LPC_ADC, ADC_CH0, &result);
    // Division and multiplication by 2 are reduced
    const unsigned x =
        static_cast<unsigned>((static_cast<unsigned>(result) * AdcReferenceMillivolts) >>
                              AdcResolutionBits);
